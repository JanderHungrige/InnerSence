function Beats_per_Epoch(pat,saving,win,loadfolder,savefolder)
...
%%%%%%%%%%%% SAVING            
    if saving                     %saving R peaks positions in mat file                 
       Saving(BpE,savefolder,Neonate,win(1,j)) 
    end% end if saving    
